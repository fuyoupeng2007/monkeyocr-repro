![](images/5bd5c5b2b8ce54c69d42b9e9f3e28f8600f296d3ad14293476abf75cdf3c7b35.jpg)  
Fig. 6. Schematics of measurement geometries (not to scale): photocatalytic reactor.  

$[NOx]_{\mathrm{max}}$: the maximized concentration of nitrogen monoxides, ppb;  

$[NOx]_{\min}$ : the minimized concentration of nitrogen monoxides, ppb;  

$t_{0}$: time point when UV light turns on;  

$t_{1}$: time point when UV light turns off;  
...
$$
r = \frac { ( \frac { f } { T _ { 2 } } ) \left\{ \int _ { t _ { 0 } } ^ { t _ { 1 } } \frac { \left( \left[ N O \right] _ { 0 } - \left[ N O \right] \right) d t + \int _ { t _ { 0 } } ^ { t _ { 1 } } \left( \left[ N O _ { 2 } \right] _ { 0 } - \left[ N O _ { 2 } \right] \right) d t } { A T } \right\} } { \left( \left[ N O \right] _ { 0 } - \left[ N O \right] \right) \left( \left[ N O _ { 2 } \right] _ { 0 } - \left[ N O _ { 2 } \right] \right) }
$$  

# where  

r: amount of nitro oxides removed by the test sample, $\mu$mol m$^{-2}$h;  

f: flow rate converted into that at the standard state (0 °C, 1.013 kPa), L min⁻¹;

[NO]₀: inlet concentration of nitrogen monoxide, ppb;

[NO]: outlet concentration of nitrogen monoxide, ppb;

[NO₂]₀: inlet concentration of nitrogen dioxide, ppb;

[NO₂]: outlet concentration of nitrogen dioxide, ppb;

A: surface area of cement paste samples, m²;
