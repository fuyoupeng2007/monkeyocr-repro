...
Creatures: Next to the bunker, two of O.S.C.A.R.'s minion robots are working inside a metal utility box. Any character who makes a successful DC10 Knowledge (technology) check recognizes it as a utility box for high-speed internet connections. The robots are attempting to restore O.S.C.A.R.'s T3 connection to the outside world.  
