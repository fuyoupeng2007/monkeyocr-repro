...
| **MinerU 120 页跑批** | ⏸️ **中断** | **81/120** | 0 失败；剩余 39 页未处理 |
| **MinerU 官方评测** | ⚠️ **不完整** | **21/120** | 中间态结果，已标注，不用于结论 |
...
> ⚠️ **使用限制**：MinerU 列来自 **21/120 页**的中间态评测，页面级均值受难度分布影响极大，
...
**结论**：扩框 5% 使平均区域编辑距离由 0.6064 降至 0.5741
...
| 6 | MinerU 评测不完整（21/120 页） | 实例中断 | **已在报告中逐处标注** |
